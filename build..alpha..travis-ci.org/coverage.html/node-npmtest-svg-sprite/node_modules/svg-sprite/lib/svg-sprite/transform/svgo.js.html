...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-svg-sprite/node_modules/svg-sprite/lib/svg-sprite/transform/svgo.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-svg-sprite/node_modules/svg-sprite/lib/svg-sprite/transform/svgo.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-svg-sprite/node_modules/svg-sprite/lib/svg-sprite/transform/</a> &#187; svgo.js</div>
</div>
<div class="body">
 ...
 */
module.exports = <span class="fstat-no" title="function not covered" >function(shape, config, spriter, cb) {</span>
<span class="cstat-no" title="statement not covered" >	config							= _.cloneDeep(config);</span>
<span class="cstat-no" title="statement not covered" >	config.plugins					= ('plugins' in config) ? defaultPluginConfig.concat(config.plugins) : defaultPluginConfig;</span>
<span class="cstat-no" title="statement not covered" >	config.plugins.push({removeXMLProcInst: !!spriter.config.svg.xmlDeclaration});</span>
<span class="cstat-no" title="statement not covered" >	config.plugins.push({removeDoctype: !!spriter.config.svg.doctypeDeclaration});</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	var svg							= shape.getSVG(false),</span>
	svgLength						= svg.length,
	svgoInstance					= new SVGO(config);
&nbsp;
<span class="cstat-no" title="statement not covered" >	try {</span>
<span class="cstat-no" title="statement not covered" >		svgoInstance.optimize(svg, <span class="fstat-no" title="function not covered" >function(result) {</span></span>
<span class="cstat-no" title="statement not covered" >			shape.setSVG(result.data);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >			if (spriter.config.log.transports.console.level === 'debug') {</span>
<span class="cstat-no" title="statement not covered" >				var optSVGLength	= shape.getSVG(false).length;</span>
<span class="cstat-no" title="statement not covered" >				spriter.debug('Optimized "%s" with SVGO (saved %s / %s%%)', shape.name, pretty(svgLength - optSVGLength), Math.round(100 * (svgLength - optSVGLength) / svgLength));</span>
			}
&nbsp;
<span class="cstat-no" title="statement not covered" >			cb(null);</span>
		});
	} catch (error) {
<span class="cstat-no" title="statement not covered" >		spriter.error('Optimizing "%s" with SVGO failed with error "%s"', shape.name, error);</span>
